...
export default function AndroidInstallPrompt({ onDismiss, allowDismiss = false, onFeedback }: AndroidInstallPromptProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-green-600 via-teal-600 to-blue-600 overflow-y-auto">
      <div className="min-h-full flex items-center justify-center p-4 py-8">
        <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 md:p-8 relative overflow-hidden my-auto">
          ...
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-green-500 to-teal-600 rounded-2xl shadow-lg flex items-center justify-center">
